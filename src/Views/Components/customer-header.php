<title><?php __($data['page_title'] ?? 'B-Bank') ?></title>
    ...
    <nav class="border-b border-emerald-300 border-opacity-25 bg-emerald-600" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
                            ...
                            <!-- Current: "bg-emerald-700 text-white", Default: "text-white hover:bg-emerald-500 hover:bg-opacity-75" -->
                             <?php
                                $getMenuItemClasses = function($route){
                                    return request()->getRoutePath() == $route ? "bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium" : "text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium";
                                }
                             ?>
                            <a href="<?php __(url('/customer/dashboard')) ?>" class="<?php echo $getMenuItemClasses('/customer/dashboard')?>" aria-current="page">Dashboard</a>
                            <a href="<?php __(url('/customer/deposit')) ?>" class="<?php echo $getMenuItemClasses('/customer/deposit')?>">Deposit</a>
                            <a href="<?php __(url('/customer/withdraw')) ?>" class="<?php echo $getMenuItemClasses('/customer/withdraw')?>">Withdraw</a>
                            <a href="<?php __(url('/customer/transfer')) ?>" class="<?php echo $getMenuItemClasses('/customer/transfer')?>">Transfer</a>
                        </div>
                    </div>
                </div>
        ...
        <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
            <div class="space-y-1 pt-2 pb-3">
                <a href="<?php __(url('/customer/dashboard')) ?>" class="bg-emerald-700 text-white block rounded-md py-2 px-3 text-base font-medium" aria-current="page">Dashboard</a>

                <a href="<?php __(url('/customer/deposit')) ?>" class="text-white hover:bg-emerald-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Deposit</a>

                <a href="<?php __(url('/customer/withdraw')) ?>" class="text-white hover:bg-emerald-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Withdraw</a>

                <a href="<?php __(url('/customer/transfer')) ?>" class="text-white hover:bg-emerald-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Transfer</a>
            </div>
            <div class="border-t border-emerald-700 pb-3 pt-4">
                ...
                <div class="mt-3 space-y-1 px-2">
                    <a href="<?php __(url('/logout')) ?>" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-emerald-500 hover:bg-opacity-75">Sign out</a>
                </div>
            </div>
        </div>
    </nav>
